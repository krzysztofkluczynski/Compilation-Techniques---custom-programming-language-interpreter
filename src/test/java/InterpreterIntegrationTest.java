...
@Test
    ...
    public void TestSelectStatement() throws Exception {
                ...
                """
                        fn List<int> main() {
                            ...
                            "hamster": 6
                             ...
                             List<int> list;
                             list = SELECT (var_dict.value) FROM var_dict;
                             return list;
        ...
        List result = (List) interpreter.execute();
        Assert.assertEquals(result, List.of(6, 4, 5, 3));
    }

    @Test
    public void TestSelectStatementDictionary() throws Exception {
        DataStreamInputReader reader = new DataStreamInputReader(
                """
                        fn Dictionary<int, String> main() {
                            ...
                            "hamster": 6
                             ...
                             list = SELECT (var_dict.value, var_dict.key) FROM var_dict;
                             return list;
    ...
    @Test
    public void TestSelectStatementListWhere() throws Exception {
        DataStreamInputReader reader = new DataStreamInputReader(
                """
                        fn List<String> main() {
                            Dictionary<String, int> var_dict = |
                            ...
                            "hamster": 6
                             ...
                             List<String> list;
                             list = SELECT (var_dict.key) FROM var_dict WHERE (var_dict.value > 3);
                             return list;
    ...
    @Test
    public void TestSelectStatementListWhereSingle() throws Exception {
        DataStreamInputReader reader = new DataStreamInputReader(
                """
                        fn int main() {
                            Dictionary<String, int> var_dict = |
                            ...
                            "hamster": 6
                             ...
                             List<int> list;
                             list = SELECT (var_dict.value) FROM var_dict WHERE (var_dict.key == "dog");
                             return list.get(0);
    ...
    @Test
    public void TestSelectStatementListWhereSingleValue() throws Exception {
        DataStreamInputReader reader = new DataStreamInputReader(
                """
                        fn List<String> main() {
                            Dictionary<String, int> var_dict = |
                            ...
                            "hamster": 6
                             ...
                             List<String> list;
                             list = SELECT (var_dict.key) FROM var_dict WHERE (var_dict.key == "dog");
                             return list;
